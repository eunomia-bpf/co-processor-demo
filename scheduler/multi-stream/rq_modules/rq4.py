...
class RQ4(RQBase):
    ...
    def _plot_rq4_4(self, ax):
        ...
        # Position-based pattern assignment (matches experiment order)
        num_runs = 3  # We ran with num_runs=3
        ...
        # Rows 0-(num_runs-1): 1 level (All Equal)
        # Rows num_runs-4*num_runs: 2 levels (1H-7L, 2H-6L, 4H-4L) - num_runs each
        # Rows 4*num_runs-5*num_runs: 5 levels (Multi-Level)
