...
def main():
    ...
    output_file = f'exploration_results_{timestamp}.csv'
    ...
    print(f"Total benchmark runs: {total_configs}")
    print()
    print("=" * 70)
    print()
    ...
    for i, (n, threads, imb, work) in enumerate(configs, 1):
        print(f"[{i}/{total_configs}] Configuration {i}:", flush=True)
